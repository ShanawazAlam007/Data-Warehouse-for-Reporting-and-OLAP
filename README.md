...
- **Internal Cloud Stage Catalog (B.6):**
![](Stage.jpeg)

- **Database Staging Tables Catalog (A.2, A.3):**
...
*Note: Metrics for Staging and ODS reflect Snowflake's internal compression logic as captured in the system catalog.*

### Metadata Query Utilized for Storage Metric Extraction:
```sql
SELECT 
    TABLE_SCHEMA,
    TABLE_NAME, 
